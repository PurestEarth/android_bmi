...
class MainActivityObeseTest {
    ...
    fun mainActivityObeseTest() {
        ...
        appCompatEditText2.perform(replaceText("145"), closeSoftKeyboard())
        ...
        val appCompatTextView = onView(
            allOf(
                withId(R.id.textView1), withText("44.76"),
                childAtPosition(
                    childAtPosition(
                        withId(R.id.nav_host_fragment),
                        0
        ...
        val textView = onView(
            allOf(
                withId(R.id.textView4), withText("44.76"),
                childAtPosition(
                    childAtPosition(
        ...
        textView.check(matches(withText("44.76")))

        val textView2 = onView(
            allOf(
                withId(R.id.textView5), withText("Try eating more"),
                childAtPosition(
                    childAtPosition(
                        IsInstanceOf.instanceOf(android.widget.FrameLayout::class.java),
                        0
